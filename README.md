...
2. Text is preprocessed using tokenization and lemmatization  
3. Converted into features (bag-of-words representation)  
4. ML model predicts user intent  
5. Fare/route logic is applied based on query type  
6. Response is generated and displayed in real-time  
